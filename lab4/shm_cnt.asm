    ...
    100b:	31 db                	xor    %ebx,%ebx
{
  ...
  pid=fork();
    1013:	e8 22 03 00 00       	call   133a <fork>
  sleep(1);
    1018:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  pid=fork();
    101f:	89 c7                	mov    %eax,%edi
  sleep(1);
    1021:	e8 ac 03 00 00       	call   13d2 <sleep>
shm_open(1,(char **)&counter);
    ...
    1078:	b8 4b 18 00 00       	mov    $0x184b,%eax
    107d:	85 ff                	test   %edi,%edi
    107f:	8b 4a 04             	mov    0x4(%edx),%ecx
    1082:	89 54 24 10          	mov    %edx,0x10(%esp)
    1086:	c7 44 24 04 84 18 00 	movl   $0x1884,0x4(%esp)
    108d:	00 
    108e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1095:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
    1099:	b9 44 18 00 00       	mov    $0x1844,%ecx
    ...
    10ad:	e8 ee 03 00 00       	call   14a0 <printf>

	
	urelease(&(counter->lock));
    10b2:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  for(i = 0; i < 10000; i++)
    10b6:	83 c3 01             	add    $0x1,%ebx
	urelease(&(counter->lock));
    10b9:	89 04 24             	mov    %eax,(%esp)
    10bc:	e8 6f 07 00 00       	call   1830 <urelease>
  for(i = 0; i < 10000; i++)
    10c1:	81 fb 10 27 00 00    	cmp    $0x2710,%ebx
    10c7:	0f 85 73 ff ff ff    	jne    1040 <main+0x40>
}
  
  if(pid)
     {
       printf(1,"Counter in parent is %d\n",counter->cnt);
    10cd:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  if(pid)
    10d1:	85 ff                	test   %edi,%edi
       printf(1,"Counter in parent is %d\n",counter->cnt);
    10d3:	8b 40 04             	mov    0x4(%eax),%eax
    10d6:	89 44 24 08          	mov    %eax,0x8(%esp)
  if(pid)
    10da:	74 2a                	je     1106 <main+0x106>
       printf(1,"Counter in parent is %d\n",counter->cnt);
    10dc:	c7 44 24 04 51 18 00 	movl   $0x1851,0x4(%esp)
    10e3:	00 
    10e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10eb:	e8 b0 03 00 00       	call   14a0 <printf>
    wait();
    10f0:	e8 55 02 00 00       	call   134a <wait>
    } else
...
//shm_close: first process will just detach, next one will free up the shm_table entry (but for now not the page)
   shm_close(1);
    ...
    10fc:	e8 e9 02 00 00       	call   13ea <shm_close>
   exit();
    1101:	e8 3c 02 00 00       	call   1342 <exit>
    printf(1,"Counter in child is %d\n\n",counter->cnt);
    1106:	c7 44 24 04 6a 18 00 	movl   $0x186a,0x4(%esp)
    110d:	00 
    110e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1115:	e8 86 03 00 00       	call   14a0 <printf>
    111a:	eb d9                	jmp    10f5 <main+0xf5>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1439:	0f b6 92 af 18 00 00 	movzbl 0x18af(%edx),%edx
  }while((x /= base) != 0);
    ...
    14ae:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    15cf:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    15d1:	b8 a8 18 00 00       	mov    $0x18a8,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1691:	a1 6c 1b 00 00       	mov    0x1b6c,%eax
{
  ...
  freep = p;
    16d9:	a3 6c 1b 00 00       	mov    %eax,0x1b6c
}
    16de:	5b                   	pop    %ebx
    16df:	5e                   	pop    %esi
    16e0:	5f                   	pop    %edi
  ...
  freep = p;
    1702:	a3 6c 1b 00 00       	mov    %eax,0x1b6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    172c:	8b 1d 6c 1b 00 00    	mov    0x1b6c,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    176b:	3b 15 6c 1b 00 00    	cmp    0x1b6c,%edx
  ...
  return freep;
    17a2:	8b 15 6c 1b 00 00    	mov    0x1b6c,%edx
    ...
    17c4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    17c7:	89 15 6c 1b 00 00    	mov    %edx,0x1b6c
      return (void*)(p + 1);
    ...
    base.s.ptr = freep = prevp = &base;
    17de:	c7 05 6c 1b 00 00 70 	movl   $0x1b70,0x1b6c
    17e5:	1b 00 00 
    base.s.size = 0;
    17e8:	ba 70 1b 00 00       	mov    $0x1b70,%edx
    base.s.ptr = freep = prevp = &base;
    17ed:	c7 05 70 1b 00 00 70 	movl   $0x1b70,0x1b70
    17f4:	1b 00 00 
    base.s.size = 0;
    17f7:	c7 05 74 1b 00 00 00 	movl   $0x0,0x1b74
    17fe:	00 00 00 
