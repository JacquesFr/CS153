...
80106d08:	ba f4 54 11 80       	mov    $0x801154f4,%edx
	//Case 1: shared memory does exist
	for(i = 0; i < 64; i++){
...
80106da7:	e8 94 d4 ff ff       	call   80104240 <release>
	...
	release(&(shm_table.lock));
	return 0; //added to remove compiler warning
}
...
80106e88:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int i;
	initlock(&(shm_table.lock), "SHM Lock");
80106e8b:	c7 44 24 04 3d 79 10 	movl   $0x8010793d,0x4(%esp)
80106e92:	80 
80106e93:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e9a:	e8 c1 d1 ff ff       	call   80104060 <initlock>
	acquire(&(shm_table.lock));
80106e9f:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ea6:	e8 a5 d2 ff ff       	call   80104150 <acquire>
80106eab:	ba f4 54 11 80       	mov    $0x801154f4,%edx
	for(i = 0; i < 64; i++){
80106eb0:	31 c0                	xor    %eax,%eax
80106eb2:	eb 0f                	jmp    80106ec3 <shm_close+0x43>
80106eb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106eb8:	83 c0 01             	add    $0x1,%eax
80106ebb:	83 c2 0c             	add    $0xc,%edx
80106ebe:	83 f8 40             	cmp    $0x40,%eax
80106ec1:	74 1d                	je     80106ee0 <shm_close+0x60>
		if(shm_table.shm_pages[i].id == id){
80106ec3:	3b 1a                	cmp    (%edx),%ebx
80106ec5:	75 f1                	jne    80106eb8 <shm_close+0x38>
			shm_table.shm_pages[i].refcnt--;
80106ec7:	8d 34 40             	lea    (%eax,%eax,2),%esi
80106eca:	c1 e6 02             	shl    $0x2,%esi
80106ecd:	8b 8e fc 54 11 80    	mov    -0x7feeab04(%esi),%ecx
80106ed3:	83 e9 01             	sub    $0x1,%ecx
			if(shm_table.shm_pages[i].refcnt > 0) break;
80106ed6:	85 c9                	test   %ecx,%ecx
			shm_table.shm_pages[i].refcnt--;
80106ed8:	89 8e fc 54 11 80    	mov    %ecx,-0x7feeab04(%esi)
			if(shm_table.shm_pages[i].refcnt > 0) break;
80106ede:	7e 38                	jle    80106f18 <shm_close+0x98>
			shm_table.shm_pages[i].frame = 0;
			shm_table.shm_pages[i].refcnt = 0;
			break;
		}
	...
	if(shm_table.shm_pages[i].id != id){
80106ee0:	8d 04 40             	lea    (%eax,%eax,2),%eax
80106ee3:	3b 1c 85 f4 54 11 80 	cmp    -0x7feeab0c(,%eax,4),%ebx
		release(&(shm_table.lock));
80106eea:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
	if(shm_table.shm_pages[i].id != id){
80106ef1:	74 15                	je     80106f08 <shm_close+0x88>
		release(&(shm_table.lock));
80106ef3:	e8 48 d3 ff ff       	call   80104240 <release>
	}
	release(&(shm_table.lock));
...
80106ef8:	83 c4 10             	add    $0x10,%esp
		return 1;
80106efb:	b8 01 00 00 00       	mov    $0x1,%eax
}
80106f00:	5b                   	pop    %ebx
80106f01:	5e                   	pop    %esi
80106f02:	5d                   	pop    %ebp
...
80106f04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	release(&(shm_table.lock));
80106f08:	e8 33 d3 ff ff       	call   80104240 <release>
}
...
80106f16:	66 90                	xchg   %ax,%ax
			shm_table.shm_pages[i].id = 0;
80106f18:	c7 86 f4 54 11 80 00 	movl   $0x0,-0x7feeab0c(%esi)
80106f1f:	00 00 00 
			shm_table.shm_pages[i].frame = 0;
80106f22:	c7 86 f8 54 11 80 00 	movl   $0x0,-0x7feeab08(%esi)
80106f29:	00 00 00 
			shm_table.shm_pages[i].refcnt = 0;
80106f2c:	c7 86 fc 54 11 80 00 	movl   $0x0,-0x7feeab04(%esi)
80106f33:	00 00 00 
			break;
80106f36:	eb a8                	jmp    80106ee0 <shm_close+0x60>
