...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 fb 75 10 80 	movl   $0x801075fb,(%esp)
...
80100d19:	89 58 44             	mov    %ebx,0x44(%eax)
  curproc->priority = 2;	//Give high priority to a newly loaded process
80100d1c:	c7 47 7c 02 00 00 00 	movl   $0x2,0x7c(%edi)
  switchuvm(curproc);
80100d23:	89 3c 24             	mov    %edi,(%esp)
80100d26:	e8 c5 58 00 00       	call   801065f0 <switchuvm>
  freevm(oldpgdir);
80100d2b:	89 34 24             	mov    %esi,(%esp)
80100d2e:	e8 1d 5c 00 00       	call   80106950 <freevm>
  return 0;
...
80101278:	e8 73 30 00 00       	call   801042f0 <memset>
  log_write(bp);
...
801012b9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
801012bc:	e8 6f 2f 00 00       	call   80104230 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801012f6:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012f9:	e8 a2 2f 00 00       	call   801042a0 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
8010133e:	e8 5d 2f 00 00       	call   801042a0 <release>
}
...
80101452:	e8 39 2f 00 00       	call   80104390 <memmove>
  brelse(bp);
...
8010148b:	e8 30 2c 00 00       	call   801040c0 <initlock>
...
801014a0:	80 
801014a1:	e8 ea 2a 00 00       	call   80103f90 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015a9:	e8 42 2d 00 00       	call   801042f0 <memset>
      dip->type = type;
...
8010165f:	00 
80101660:	e8 2b 2d 00 00       	call   80104390 <memmove>
  log_write(bp);
...
80101691:	e8 9a 2b 00 00       	call   80104230 <acquire>
  ip->ref++;
80101696:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010169a:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016a1:	e8 fa 2b 00 00       	call   801042a0 <release>
}
...
801016d4:	e8 f7 28 00 00       	call   80103fd0 <acquiresleep>
  if(ip->valid == 0){
...
8010174b:	e8 40 2c 00 00       	call   80104390 <memmove>
    brelse(bp);
...
801017a5:	e8 c6 28 00 00       	call   80104070 <holdingsleep>
...
801017bd:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017be:	e9 6d 28 00 00       	jmp    80104030 <releasesleep>
    panic("iunlock");
...
801017e2:	e8 e9 27 00 00       	call   80103fd0 <acquiresleep>
...
801017f8:	e8 33 28 00 00       	call   80104030 <releasesleep>
  acquire(&icache.lock);
801017fd:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101804:	e8 27 2a 00 00       	call   80104230 <acquire>
  ip->ref--;
...
8010181a:	5d                   	pop    %ebp
  release(&icache.lock);
8010181b:	e9 80 2a 00 00       	jmp    801042a0 <release>
    acquire(&icache.lock);
80101820:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101827:	e8 04 2a 00 00       	call   80104230 <acquire>
    int r = ip->ref;
8010182c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010182f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101836:	e8 65 2a 00 00       	call   801042a0 <release>
    if(r == 1){
...
80101a08:	e8 83 29 00 00       	call   80104390 <memmove>
    brelse(bp);
...
80101b04:	e8 87 28 00 00       	call   80104390 <memmove>
    log_write(bp);
...
80101bab:	e8 60 28 00 00       	call   80104410 <strncmp>
}
80101bb0:	c9                   	leave  
80101bb1:	c3                   	ret    
...
80101c29:	e8 e2 27 00 00       	call   80104410 <strncmp>
      continue;
...
80101ca8:	e8 83 25 00 00       	call   80104230 <acquire>
  ip->ref++;
80101cad:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cb1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cb8:	e8 e3 25 00 00       	call   801042a0 <release>
...
80101d1b:	e8 70 26 00 00       	call   80104390 <memmove>
    path++;
...
80101da9:	e8 e2 25 00 00       	call   80104390 <memmove>
    name[len] = 0;
...
80101ea3:	e8 d8 25 00 00       	call   80104480 <strncpy>
  de.inum = inum;
...
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 e2 73 10 80 	movl   $0x801073e2,(%esp)
...
80102015:	e8 a6 20 00 00       	call   801040c0 <initlock>
...
80102090:	e8 9b 21 00 00       	call   80104230 <acquire>
...
801020d6:	e8 c5 21 00 00       	call   801042a0 <release>
...
80102130:	e8 3b 1f 00 00       	call   80104070 <holdingsleep>
...
80102166:	e8 c5 20 00 00       	call   80104230 <acquire>
...
801021c5:	5d                   	pop    %ebp
  release(&idelock);
801021c6:	e9 d5 20 00 00       	jmp    801042a0 <release>
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
...
8010232a:	e8 c1 1f 00 00       	call   801042f0 <memset>
...
801023fa:	e8 c1 1c 00 00       	call   801040c0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024cd:	e8 ce 1d 00 00       	call   801042a0 <release>
  return (char*)r;
}
...
801024e7:	e8 44 1d 00 00       	call   80104230 <acquire>
...
8010289c:	e8 9f 1a 00 00       	call   80104340 <memcmp>
...
801029c7:	e8 c4 19 00 00       	call   80104390 <memmove>
...
80102a8a:	e8 31 16 00 00       	call   801040c0 <initlock>
  readsb(dev, &sb);
...
80102b1d:	e8 0e 17 00 00       	call   80104230 <acquire>
...
80102b37:	e8 14 11 00 00       	call   80103c50 <sleep>
    if(log.committing){
...
80102b65:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b6a:	e8 31 17 00 00       	call   801042a0 <release>
      break;
    }
  }
}
...
80102b90:	e8 9b 16 00 00       	call   80104230 <acquire>
  log.outstanding -= 1;
...
80102bc8:	00 00 00 
  release(&log.lock);
80102bcb:	e8 d0 16 00 00       	call   801042a0 <release>
  if (log.lh.n > 0) {
...
80102c2f:	e8 5c 17 00 00       	call   80104390 <memmove>
...
80102ced:	e8 3e 15 00 00       	call   80104230 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d3e:	5d                   	pop    %ebp
  release(&log.lock);
80102d3f:	e9 5c 15 00 00       	jmp    801042a0 <release>
...
80102e71:	e8 1a 15 00 00       	call   80104390 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f4b:	e8 f0 13 00 00       	call   80104340 <memcmp>
...
80103006:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103009:	e8 32 13 00 00       	call   80104340 <memcmp>
...
801031e6:	80 
801031e7:	e8 d4 0e 00 00       	call   801040c0 <initlock>
  (*f0)->type = FD_PIPE;
...
80103271:	e8 ba 0f 00 00       	call   80104230 <acquire>
  if(writable){
...
8010328d:	e8 4e 0b 00 00       	call   80103de0 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032ae:	5d                   	pop    %ebp
    release(&p->lock);
801032af:	e9 ec 0f 00 00       	jmp    801042a0 <release>
...
801032ff:	e8 2c 0f 00 00       	call   80104230 <acquire>
  for(i = 0; i < n; i++){
...
8010334f:	e8 8c 0a 00 00       	call   80103de0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103354:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80103358:	89 34 24             	mov    %esi,(%esp)
8010335b:	e8 f0 08 00 00       	call   80103c50 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103382:	e8 19 0f 00 00       	call   801042a0 <release>
        return -1;
...
801033ca:	e8 11 0a 00 00       	call   80103de0 <wakeup>
  release(&p->lock);
801033cf:	89 1c 24             	mov    %ebx,(%esp)
801033d2:	e8 c9 0e 00 00       	call   801042a0 <release>
  return n;
...
801033f2:	e8 39 0e 00 00       	call   80104230 <acquire>
...
8010341f:	e8 2c 08 00 00       	call   80103c50 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010344b:	e8 50 0e 00 00       	call   801042a0 <release>
...
801034a5:	e8 36 09 00 00       	call   80103de0 <wakeup>
  release(&p->lock);
801034aa:	89 34 24             	mov    %esi,(%esp)
801034ad:	e8 ee 0d 00 00       	call   801042a0 <release>
}
...
801034d3:	e8 58 0d 00 00       	call   80104230 <acquire>
...
80103519:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
8010351c:	e8 7f 0d 00 00       	call   801042a0 <release>
...
80103538:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010353b:	c7 40 14 65 54 10 80 	movl   $0x80105465,0x14(%eax)
...
80103555:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103558:	e8 93 0d 00 00       	call   801042f0 <memset>
...
80103577:	e8 24 0d 00 00       	call   801042a0 <release>
}
...
8010359d:	e8 fe 0c 00 00       	call   801042a0 <release>
...
801035f5:	e8 c6 0a 00 00       	call   801040c0 <initlock>
}
801035fa:	c9                   	leave  
801035fb:	c3                   	ret    
...
801036a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036a7:	e8 94 0a 00 00       	call   80104140 <pushcli>
  c = mycpu();
801036ac:	e8 4f ff ff ff       	call   80103600 <mycpu>
  p = c->proc;
801036b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036b7:	e8 c4 0a 00 00       	call   80104180 <popcli>
}
...
80103703:	e8 c8 32 00 00       	call   801069d0 <setupkvm>
...
80103725:	80 
80103726:	e8 d5 2f 00 00       	call   80106700 <inituvm>
  p->sz = PGSIZE;
...
80103747:	e8 a4 0b 00 00       	call   801042f0 <memset>
...
801037a2:	00 
801037a3:	c7 44 24 04 05 72 10 	movl   $0x80107205,0x4(%esp)
801037aa:	80 
801037ab:	89 04 24             	mov    %eax,(%esp)
801037ae:	e8 1d 0d 00 00       	call   801044d0 <safestrcpy>
  p->cwd = namei("/");
801037b3:	c7 04 24 0e 72 10 80 	movl   $0x8010720e,(%esp)
...
801037e7:	c7 04 24 ec 71 10 80 	movl   $0x801071ec,(%esp)
...
80103829:	e8 12 30 00 00       	call   80106840 <allocuvm>
...
80103837:	e8 b4 2d 00 00       	call   801065f0 <switchuvm>
  return 0;
...
8010385a:	e8 d1 30 00 00       	call   80106930 <deallocuvm>
...
8010389e:	e8 0d 32 00 00       	call   80106ab0 <copyuvm>
...
801039a5:	bf 54 2d 11 80       	mov    $0x80112d54,%edi
    acquire(&ptable.lock);
801039aa:	e8 81 08 00 00       	call   80104230 <acquire>
...
801039c1:	73 7b                	jae    80103a3e <scheduler+0xbe>
      if(p->state != RUNNABLE){
801039c3:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
801039c7:	75 ef                	jne    801039b8 <scheduler+0x38>
801039c9:	b9 1f 00 00 00       	mov    $0x1f,%ecx
801039ce:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
801039d3:	eb 0e                	jmp    801039e3 <scheduler+0x63>
801039d5:	8d 76 00             	lea    0x0(%esi),%esi
      for(p1 = ptable.proc; p1 < &ptable.proc[NPROC]; p1++){
801039d8:	83 ea 80             	sub    $0xffffff80,%edx
801039db:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
801039e1:	74 1d                	je     80103a00 <scheduler+0x80>
	if(p1->state != RUNNABLE){
801039e3:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
801039e7:	75 ef                	jne    801039d8 <scheduler+0x58>
	if(p1->priority < highpri){	//larger value, lower its priority
801039e9:	8b 42 7c             	mov    0x7c(%edx),%eax
801039ec:	39 c8                	cmp    %ecx,%eax
801039ee:	7d e8                	jge    801039d8 <scheduler+0x58>
801039f0:	89 d7                	mov    %edx,%edi
      for(p1 = ptable.proc; p1 < &ptable.proc[NPROC]; p1++){
801039f2:	83 ea 80             	sub    $0xffffff80,%edx
801039f5:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
801039fb:	89 c1                	mov    %eax,%ecx
801039fd:	75 e4                	jne    801039e3 <scheduler+0x63>
801039ff:	90                   	nop
      c->proc = p;
80103a00:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
80103a06:	89 3c 24             	mov    %edi,(%esp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a09:	83 ef 80             	sub    $0xffffff80,%edi
      switchuvm(p);
80103a0c:	e8 df 2b 00 00       	call   801065f0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103a11:	8b 47 9c             	mov    -0x64(%edi),%eax
      p->state = RUNNING;
80103a14:	c7 47 8c 04 00 00 00 	movl   $0x4,-0x74(%edi)
      swtch(&(c->scheduler), p->context);
80103a1b:	89 34 24             	mov    %esi,(%esp)
80103a1e:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a22:	e8 04 0b 00 00       	call   8010452b <swtch>
      switchkvm();
80103a27:	e8 a4 2b 00 00       	call   801065d0 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a2c:	81 ff 54 4d 11 80    	cmp    $0x80114d54,%edi
      c->proc = 0;
80103a32:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103a39:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a3c:	72 85                	jb     801039c3 <scheduler+0x43>
    release(&ptable.lock);
80103a3e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a45:	e8 56 08 00 00       	call   801042a0 <release>
  }
80103a4a:	e9 4e ff ff ff       	jmp    8010399d <scheduler+0x1d>
80103a4f:	90                   	nop
...
80103abe:	c7 04 24 10 72 10 80 	movl   $0x80107210,(%esp)
80103ac5:	e8 96 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103aca:	c7 04 24 3c 72 10 80 	movl   $0x8010723c,(%esp)
80103ad1:	e8 8a c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103ad6:	c7 04 24 2e 72 10 80 	movl   $0x8010722e,(%esp)
80103add:	e8 7e c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103ae2:	c7 04 24 22 72 10 80 	movl   $0x80107222,(%esp)
...
80103af7:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103afa:	e8 a1 fb ff ff       	call   801036a0 <myproc>
  if(curproc == initproc)
...
80103b53:	e8 d8 06 00 00       	call   80104230 <acquire>
...
80103be6:	e8 65 fe ff ff       	call   80103a50 <sched>
  panic("zombie exit");
80103beb:	c7 04 24 5d 72 10 80 	movl   $0x8010725d,(%esp)
80103bf2:	e8 69 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103bf7:	c7 04 24 50 72 10 80 	movl   $0x80107250,(%esp)
...
80103c1d:	e8 0e 06 00 00       	call   80104230 <acquire>
  myproc()->state = RUNNABLE;
80103c22:	e8 79 fa ff ff       	call   801036a0 <myproc>
...
80103c5c:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
80103c5f:	e8 3c fa ff ff       	call   801036a0 <myproc>
  if(p == 0)
...
80103c81:	e8 aa 05 00 00       	call   80104230 <acquire>
    release(lk);
...
80103cb9:	5d                   	pop    %ebp
    acquire(lk);
80103cba:	e9 71 05 00 00       	jmp    80104230 <acquire>
80103cbf:	90                   	nop
  p->chan = chan;
...
80103cde:	c7 04 24 6f 72 10 80 	movl   $0x8010726f,(%esp)
80103ce5:	e8 76 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103cea:	c7 04 24 69 72 10 80 	movl   $0x80107269,(%esp)
...
80103d05:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103d08:	e8 93 f9 ff ff       	call   801036a0 <myproc>
  acquire(&ptable.lock);
80103d0d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103d14:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103d16:	e8 15 05 00 00       	call   80104230 <acquire>
    havekids = 0;
...
80103d88:	e8 c3 2b 00 00       	call   80106950 <freevm>
        release(&ptable.lock);
...
80103dad:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103db4:	e8 e7 04 00 00       	call   801042a0 <release>
}
...
80103dc9:	e8 d2 04 00 00       	call   801042a0 <release>
}
...
80103df1:	e8 3a 04 00 00       	call   80104230 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103e33:	5d                   	pop    %ebp
  release(&ptable.lock);
80103e34:	e9 67 04 00 00       	jmp    801042a0 <release>
...
80103e83:	e8 18 04 00 00       	call   801042a0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103ea7:	e8 f4 03 00 00       	call   801042a0 <release>
}
...
80103ed4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103ed8:	c7 04 24 fb 75 10 80 	movl   $0x801075fb,(%esp)
...
80103efa:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103efd:	ba 80 72 10 80       	mov    $0x80107280,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f02:	77 11                	ja     80103f15 <procdump+0x55>
80103f04:	8b 14 85 e0 72 10 80 	mov    -0x7fef8d20(,%eax,4),%edx
      state = "???";
80103f0b:	b8 80 72 10 80       	mov    $0x80107280,%eax
...
80103f20:	c7 04 24 84 72 10 80 	movl   $0x80107284,(%esp)
...
80103f4c:	e8 8f 01 00 00       	call   801040e0 <getcallerpcs>
...
80103f69:	c7 04 24 c1 6c 10 80 	movl   $0x80106cc1,(%esp)
...
80103f9a:	c7 44 24 04 f8 72 10 	movl   $0x801072f8,0x4(%esp)
80103fa1:	80 
...
80104002:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104008:	e8 93 f6 ff ff       	call   801036a0 <myproc>
...
80104092:	e8 09 f6 ff ff       	call   801036a0 <myproc>
...
8010418b:	75 49                	jne    801041d6 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
8010418d:	e8 6e f4 ff ff       	call   80103600 <mycpu>
...
801041a5:	e8 56 f4 ff ff       	call   80103600 <mycpu>
...
801041c9:	c3                   	ret    
    panic("popcli");
801041ca:	c7 04 24 1a 73 10 80 	movl   $0x8010731a,(%esp)
801041d1:	e8 8a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
801041d6:	c7 04 24 03 73 10 80 	movl   $0x80107303,(%esp)
...
80104249:	75 3a                	jne    80104285 <acquire+0x55>
  asm volatile("lock; xchgl %0, %1" :
...
8010425a:	75 f4                	jne    80104250 <acquire+0x20>
  __sync_synchronize();
8010425c:	0f ae f0             	mfence 
  lk->cpu = mycpu();
8010425f:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104262:	e8 99 f3 ff ff       	call   80103600 <mycpu>
80104267:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
8010426a:	8b 45 08             	mov    0x8(%ebp),%eax
8010426d:	83 c0 0c             	add    $0xc,%eax
80104270:	89 44 24 04          	mov    %eax,0x4(%esp)
80104274:	8d 45 08             	lea    0x8(%ebp),%eax
80104277:	89 04 24             	mov    %eax,(%esp)
8010427a:	e8 61 fe ff ff       	call   801040e0 <getcallerpcs>
}
8010427f:	83 c4 14             	add    $0x14,%esp
80104282:	5b                   	pop    %ebx
80104283:	5d                   	pop    %ebp
80104284:	c3                   	ret    
    panic("acquire");
80104285:	c7 04 24 21 73 10 80 	movl   $0x80107321,(%esp)
8010428c:	e8 cf c0 ff ff       	call   80100360 <panic>
80104291:	eb 0d                	jmp    801042a0 <release>
80104293:	90                   	nop
80104294:	90                   	nop
80104295:	90                   	nop
80104296:	90                   	nop
...
801042b4:	74 21                	je     801042d7 <release+0x37>
  lk->pcs[0] = 0;
801042b6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
801042bd:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
801042c4:	0f ae f0             	mfence 
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
801042c7:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
801042cd:	83 c4 14             	add    $0x14,%esp
801042d0:	5b                   	pop    %ebx
801042d1:	5d                   	pop    %ebp
  popcli();
801042d2:	e9 a9 fe ff ff       	jmp    80104180 <popcli>
    panic("release");
801042d7:	c7 04 24 29 73 10 80 	movl   $0x80107329,(%esp)
801042de:	e8 7d c0 ff ff       	call   80100360 <panic>
...
80104547:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010454a:	e8 51 f1 ff ff       	call   801036a0 <myproc>
...
80104618:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010461b:	e8 80 f0 ff ff       	call   801036a0 <myproc>
...
801046b5:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
801046b8:	e8 e3 ef ff ff       	call   801036a0 <myproc>
...
801046c8:	83 fa 15             	cmp    $0x15,%edx
801046cb:	77 1b                	ja     801046e8 <syscall+0x38>
801046cd:	8b 14 85 60 73 10 80 	mov    -0x7fef8ca0(,%eax,4),%edx
...
801046f6:	c7 04 24 31 73 10 80 	movl   $0x80107331,(%esp)
...
80104726:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
80104729:	e8 72 ef ff ff       	call   801036a0 <myproc>
...
80104766:	83 ec 3c             	sub    $0x3c,%esp
80104769:	89 4d d0             	mov    %ecx,-0x30(%ebp)
...
{
80104779:	89 55 d4             	mov    %edx,-0x2c(%ebp)
8010477c:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010477f:	e8 9c d7 ff ff       	call   80101f20 <nameiparent>
...
80104791:	e8 1a cf ff ff       	call   801016b0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104796:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010479d:	00 
8010479e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801047a2:	89 3c 24             	mov    %edi,(%esp)
801047a5:	e8 16 d4 ff ff       	call   80101bc0 <dirlookup>
801047aa:	85 c0                	test   %eax,%eax
801047ac:	89 c6                	mov    %eax,%esi
801047ae:	74 40                	je     801047f0 <create+0x90>
    iunlockput(dp);
801047b0:	89 3c 24             	mov    %edi,(%esp)
801047b3:	e8 58 d1 ff ff       	call   80101910 <iunlockput>
    ilock(ip);
801047b8:	89 34 24             	mov    %esi,(%esp)
801047bb:	e8 f0 ce ff ff       	call   801016b0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801047c0:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801047c5:	75 11                	jne    801047d8 <create+0x78>
801047c7:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
801047cc:	89 f0                	mov    %esi,%eax
801047ce:	75 08                	jne    801047d8 <create+0x78>
...
801047db:	e8 30 d1 ff ff       	call   80101910 <iunlockput>
}
...
8010480f:	e8 9c ce ff ff       	call   801016b0 <ilock>
  ip->major = major;
80104814:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80104818:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
8010481c:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
...
80104830:	e8 bb cd ff ff       	call   801015f0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104835:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
...
8010484a:	e8 d1 d5 ff ff       	call   80101e20 <dirlink>
8010484f:	85 c0                	test   %eax,%eax
80104851:	78 6c                	js     801048bf <create+0x15f>
  iunlockput(dp);
80104853:	89 3c 24             	mov    %edi,(%esp)
80104856:	e8 b5 d0 ff ff       	call   80101910 <iunlockput>
}
8010485b:	83 c4 3c             	add    $0x3c,%esp
  return ip;
...
801048b1:	79 89                	jns    8010483c <create+0xdc>
      panic("create dots");
801048b3:	c7 04 24 cb 73 10 80 	movl   $0x801073cb,(%esp)
801048ba:	e8 a1 ba ff ff       	call   80100360 <panic>
    panic("create: dirlink");
801048bf:	c7 04 24 da 73 10 80 	movl   $0x801073da,(%esp)
801048c6:	e8 95 ba ff ff       	call   80100360 <panic>
    panic("create: ialloc");
801048cb:	c7 04 24 bc 73 10 80 	movl   $0x801073bc,(%esp)
...
80104909:	e8 92 ed ff ff       	call   801036a0 <myproc>
...
80104a83:	78 23                	js     80104aa8 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104a85:	e8 16 ec ff ff       	call   801036a0 <myproc>
...
80104b39:	0f 88 cb 00 00 00    	js     80104c0a <sys_link+0x10a>
  begin_op();
80104b3f:	e8 cc df ff ff       	call   80102b10 <begin_op>
  if((ip = namei(old)) == 0){
80104b44:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104b47:	89 04 24             	mov    %eax,(%esp)
80104b4a:	e8 b1 d3 ff ff       	call   80101f00 <namei>
...
80104b77:	e8 74 ca ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
80104b7c:	89 1c 24             	mov    %ebx,(%esp)
80104b7f:	e8 0c cc ff ff       	call   80101790 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104b84:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104b87:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104b8b:	89 04 24             	mov    %eax,(%esp)
80104b8e:	e8 8d d3 ff ff       	call   80101f20 <nameiparent>
...
80104bb5:	e8 66 d2 ff ff       	call   80101e20 <dirlink>
80104bba:	85 c0                	test   %eax,%eax
80104bbc:	78 22                	js     80104be0 <sys_link+0xe0>
  iunlockput(dp);
80104bbe:	89 34 24             	mov    %esi,(%esp)
80104bc1:	e8 4a cd ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104bc6:	89 1c 24             	mov    %ebx,(%esp)
80104bc9:	e8 02 cc ff ff       	call   801017d0 <iput>
  end_op();
80104bce:	e8 ad df ff ff       	call   80102b80 <end_op>
}
...
80104be3:	e8 28 cd ff ff       	call   80101910 <iunlockput>
  ilock(ip);
80104be8:	89 1c 24             	mov    %ebx,(%esp)
80104beb:	e8 c0 ca ff ff       	call   801016b0 <ilock>
  ip->nlink--;
80104bf0:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104bf5:	89 1c 24             	mov    %ebx,(%esp)
80104bf8:	e8 f3 c9 ff ff       	call   801015f0 <iupdate>
  iunlockput(ip);
80104bfd:	89 1c 24             	mov    %ebx,(%esp)
80104c00:	e8 0b cd ff ff       	call   80101910 <iunlockput>
  end_op();
80104c05:	e8 76 df ff ff       	call   80102b80 <end_op>
}
...
80104c3e:	0f 88 76 01 00 00    	js     80104dba <sys_unlink+0x19a>
  begin_op();
80104c44:	e8 c7 de ff ff       	call   80102b10 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104c56:	e8 c5 d2 ff ff       	call   80101f20 <nameiparent>
...
80104c71:	c7 44 24 04 d8 73 10 	movl   $0x801073d8,0x4(%esp)
80104c78:	80 
80104c79:	89 1c 24             	mov    %ebx,(%esp)
80104c7c:	e8 0f cf ff ff       	call   80101b90 <namecmp>
80104c81:	85 c0                	test   %eax,%eax
80104c83:	0f 84 21 01 00 00    	je     80104daa <sys_unlink+0x18a>
80104c89:	c7 44 24 04 d7 73 10 	movl   $0x801073d7,0x4(%esp)
80104c90:	80 
80104c91:	89 1c 24             	mov    %ebx,(%esp)
80104c94:	e8 f7 ce ff ff       	call   80101b90 <namecmp>
...
80104caf:	e8 0c cf ff ff       	call   80101bc0 <dirlookup>
...
80104cc1:	e8 ea c9 ff ff       	call   801016b0 <ilock>
  if(ip->nlink < 1)
...
80104d0c:	e8 4f cd ff ff       	call   80101a60 <writei>
...
80104d2b:	e8 e0 cb ff ff       	call   80101910 <iunlockput>
  ip->nlink--;
80104d30:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104d35:	89 1c 24             	mov    %ebx,(%esp)
80104d38:	e8 b3 c8 ff ff       	call   801015f0 <iupdate>
  iunlockput(ip);
80104d3d:	89 1c 24             	mov    %ebx,(%esp)
80104d40:	e8 cb cb ff ff       	call   80101910 <iunlockput>
  end_op();
80104d45:	e8 36 de ff ff       	call   80102b80 <end_op>
}
...
80104d91:	e8 ca cb ff ff       	call   80101960 <readi>
...
80104da5:	e8 66 cb ff ff       	call   80101910 <iunlockput>
  iunlockput(dp);
...
80104dd3:	e8 18 c8 ff ff       	call   801015f0 <iupdate>
80104dd8:	e9 48 ff ff ff       	jmp    80104d25 <sys_unlink+0x105>
      panic("isdirempty: readi");
80104ddd:	c7 04 24 fc 73 10 80 	movl   $0x801073fc,(%esp)
80104de4:	e8 77 b5 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104de9:	c7 04 24 0e 74 10 80 	movl   $0x8010740e,(%esp)
80104df0:	e8 6b b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104df5:	c7 04 24 ea 73 10 80 	movl   $0x801073ea,(%esp)
...
80104e49:	0f 88 b6 00 00 00    	js     80104f05 <sys_open+0xf5>
  ...
  begin_op();
80104e4f:	e8 bc dc ff ff       	call   80102b10 <begin_op>
...
80104e64:	e8 97 d0 ff ff       	call   80101f00 <namei>
...
80104e76:	e8 35 c8 ff ff       	call   801016b0 <ilock>
...
80104ea7:	e8 e4 c8 ff ff       	call   80101790 <iunlock>
  end_op();
80104eac:	e8 cf dc ff ff       	call   80102b80 <end_op>
...
80104efc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    end_op();
80104f00:	e8 7b dc ff ff       	call   80102b80 <end_op>
}
...
80105045:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105048:	e8 53 e6 ff ff       	call   801036a0 <myproc>
8010504d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010504f:	e8 bc da ff ff       	call   80102b10 <begin_op>
...
80105071:	e8 8a ce ff ff       	call   80101f00 <namei>
...
8010507f:	e8 2c c6 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
...
8010508c:	75 22                	jne    801050b0 <sys_chdir+0x70>
  ...
  iunlock(ip);
8010508e:	e8 fd c6 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105093:	8b 46 68             	mov    0x68(%esi),%eax
80105096:	89 04 24             	mov    %eax,(%esp)
80105099:	e8 32 c7 ff ff       	call   801017d0 <iput>
  end_op();
8010509e:	e8 dd da ff ff       	call   80102b80 <end_op>
  curproc->cwd = ip;
  return 0;
...
801051f3:	e8 78 df ff ff       	call   80103170 <pipealloc>
...
80105229:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105230:	e8 6b e4 ff ff       	call   801036a0 <myproc>
...
8010526a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010526e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105275:	e8 66 f3 ff ff       	call   801045e0 <argint>
8010527a:	85 c0                	test   %eax,%eax
8010527c:	89 c3                	mov    %eax,%ebx
8010527e:	75 18                	jne    80105298 <sys_setpriority+0x38>
	return -1;
    }
...
80105286:	e8 45 e4 ff ff       	call   801036d0 <setpriority>
    return 0; 
}
8010528b:	83 c4 24             	add    $0x24,%esp
8010528e:	89 d8                	mov    %ebx,%eax
80105290:	5b                   	pop    %ebx
80105291:	5d                   	pop    %ebp
80105292:	c3                   	ret    
80105293:	90                   	nop
...
8010529d:	eb ec                	jmp    8010528b <sys_setpriority+0x2b>
8010529f:	90                   	nop
...
801052a3:	5d                   	pop    %ebp
  return fork();
801052a4:	e9 c7 e5 ff ff       	jmp    80103870 <fork>
...
801052b3:	83 ec 08             	sub    $0x8,%esp
  exit();
801052b6:	e8 35 e8 ff ff       	call   80103af0 <exit>
...
801052c3:	5d                   	pop    %ebp
  return wait();
801052c4:	e9 37 ea ff ff       	jmp    80103d00 <wait>
...
801052e4:	e8 f7 f2 ff ff       	call   801045e0 <argint>
...
801052f3:	e8 48 eb ff ff       	call   80103e40 <kill>
}
801052f8:	c9                   	leave  
801052f9:	c3                   	ret    
...
80105313:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105316:	e8 85 e3 ff ff       	call   801036a0 <myproc>
...
80105335:	e8 a6 f2 ff ff       	call   801045e0 <argint>
8010533a:	85 c0                	test   %eax,%eax
8010533c:	78 22                	js     80105360 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010533e:	e8 5d e3 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
...
8010534b:	e8 b0 e4 ff ff       	call   80103800 <growproc>
...
80105385:	e8 56 f2 ff ff       	call   801045e0 <argint>
8010538a:	85 c0                	test   %eax,%eax
8010538c:	78 7e                	js     8010540c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010538e:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105395:	e8 96 ee ff ff       	call   80104230 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010539a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010539d:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
801053b0:	c7 44 24 04 60 4d 11 	movl   $0x80114d60,0x4(%esp)
801053b7:	80 
801053b8:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
801053bf:	e8 8c e8 ff ff       	call   80103c50 <sleep>
  while(ticks - ticks0 < n){
801053c4:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
801053da:	74 d4                	je     801053b0 <sys_sleep+0x40>
      release(&tickslock);
801053dc:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801053e3:	e8 b8 ee ff ff       	call   801042a0 <release>
      return -1;
...
801053f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
801053f8:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801053ff:	e8 9c ee ff ff       	call   801042a0 <release>
}
...
80105424:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105427:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010542e:	e8 fd ed ff ff       	call   80104230 <acquire>
  xticks = ticks;
80105433:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
80105439:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105440:	e8 5b ee ff ff       	call   801042a0 <release>
  return xticks;
}
...
80105484:	66 89 0c c5 a2 4d 11 	mov    %cx,-0x7feeb25e(,%eax,8)
8010548b:	80 
8010548c:	c6 04 c5 a4 4d 11 80 	movb   $0x0,-0x7feeb25c(,%eax,8)
80105493:	00 
80105494:	c6 04 c5 a5 4d 11 80 	movb   $0x8e,-0x7feeb25b(,%eax,8)
8010549b:	8e 
8010549c:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
801054a3:	80 
801054a4:	c1 ea 10             	shr    $0x10,%edx
801054a7:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
801054ae:	80 
  for(i = 0; i < 256; i++)
...
801054c9:	c7 44 24 04 1d 74 10 	movl   $0x8010741d,0x4(%esp)
801054d0:	80 
801054d1:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801054d8:	66 89 15 a2 4f 11 80 	mov    %dx,0x80114fa2
801054df:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
801054e5:	c1 e8 10             	shr    $0x10,%eax
801054e8:	c6 05 a4 4f 11 80 00 	movb   $0x0,0x80114fa4
801054ef:	c6 05 a5 4f 11 80 ef 	movb   $0xef,0x80114fa5
801054f6:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
801054fc:	e8 bf eb ff ff       	call   801040c0 <initlock>
}
80105501:	c9                   	leave  
80105502:	c3                   	ret    
...
8010551b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010551f:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
80105560:	ff 24 85 c4 74 10 80 	jmp    *-0x7fef8b3c(,%eax,4)
80105567:	90                   	nop
    lapiceoi();
    break;
...
801055d3:	c7 04 24 80 74 10 80 	movl   $0x80107480,(%esp)
...
8010565b:	75 a8                	jne    80105605 <trap+0xc5>
    exit();
8010565d:	e8 8e e4 ff ff       	call   80103af0 <exit>
...
80105670:	75 a9                	jne    8010561b <trap+0xdb>
    yield();
80105672:	e8 99 e5 ff ff       	call   80103c10 <yield>
...
801056cc:	c7 04 24 28 74 10 80 	movl   $0x80107428,(%esp)
...
80105711:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105714:	e8 97 ef ff ff       	call   801046b0 <syscall>
    if(myproc()->killed)
...
8010578a:	c7 04 24 4c 74 10 80 	movl   $0x8010744c,(%esp)
80105791:	89 44 24 04          	mov    %eax,0x4(%esp)
80105795:	e8 b6 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
8010579a:	c7 04 24 22 74 10 80 	movl   $0x80107422,(%esp)
...
80105897:	00 
  for(p="xv6...\n"; *p; p++)
80105898:	bb 44 75 10 80       	mov    $0x80107544,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801063c2:	e8 29 df ff ff       	call   801042f0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106461:	c3                   	ret    
      panic("remap");
80106462:	c7 04 24 4c 75 10 80 	movl   $0x8010754c,(%esp)
...
801065d0:	a1 a4 55 11 80       	mov    0x801155a4,%eax
{
...
80106614:	0f 84 c3 00 00 00    	je     801066dd <switchuvm+0xed>
  pushcli();
8010661a:	e8 21 db ff ff       	call   80104140 <pushcli>
...
801066cb:	5d                   	pop    %ebp
  popcli();
801066cc:	e9 af da ff ff       	jmp    80104180 <popcli>
    panic("switchuvm: no process");
801066d1:	c7 04 24 52 75 10 80 	movl   $0x80107552,(%esp)
801066d8:	e8 83 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801066dd:	c7 04 24 7d 75 10 80 	movl   $0x8010757d,(%esp)
801066e4:	e8 77 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
801066e9:	c7 04 24 68 75 10 80 	movl   $0x80107568,(%esp)
...
80106737:	e8 b4 db ff ff       	call   801042f0 <memset>
...
8010676b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
8010676c:	e9 1f dc ff ff       	jmp    80104390 <memmove>
    panic("inituvm: more than a page");
80106771:	c7 04 24 91 75 10 80 	movl   $0x80107591,(%esp)
...
80106822:	c7 04 24 ab 75 10 80 	movl   $0x801075ab,(%esp)
80106829:	e8 32 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010682e:	c7 04 24 4c 76 10 80 	movl   $0x8010764c,(%esp)
...
80106883:	e8 68 da ff ff       	call   801042f0 <memset>
...
801068c1:	c7 04 24 c9 75 10 80 	movl   $0x801075c9,(%esp)
...
801068f0:	c7 04 24 e1 75 10 80 	movl   $0x801075e1,(%esp)
...
801069b3:	e9 38 b9 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
801069b8:	c7 04 24 fd 75 10 80 	movl   $0x801075fd,(%esp)
...
801069fb:	e8 f0 d8 ff ff       	call   801042f0 <memset>
...
80106a6b:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106a9b:	c3                   	ret    
    panic("clearpteu");
80106a9c:	c7 04 24 0e 76 10 80 	movl   $0x8010760e,(%esp)
...
80106aed:	e8 9e d8 ff ff       	call   80104390 <memmove>
...
80106b84:	eb d8                	jmp    80106b5e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106b86:	c7 04 24 32 76 10 80 	movl   $0x80107632,(%esp)
80106b8d:	e8 ce 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106b92:	c7 04 24 18 76 10 80 	movl   $0x80107618,(%esp)
...
80106c1c:	e8 6f d7 ff ff       	call   80104390 <memmove>
    len -= n;
    buf += n;
